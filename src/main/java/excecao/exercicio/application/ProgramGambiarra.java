...
import excecao.exercicio.model.entities.AccountGambiarra;
import excecao.exercicio.model.entities.AccountSolucaoRuim;

import java.util.Locale;
import java.util.Scanner;

public class ProgramGambiarra {
    ...
    public static void main(String[] args) {
        ...
        AccountGambiarra acc = new AccountGambiarra(number,holder,balance,witdrawLimit);
